...
import UIKit
protocol LeeHomeBottomViewDelegate:class  {
...
class LeeHomeBottomView: UIView {
    weak var delegate:LeeHomeBottomViewDelegate?
...
extension LeeHomeBottomView :UICollectionViewDataSource {
...
extension LeeHomeBottomView :UICollectionViewDelegate {
