...
import UIKit
protocol LeeProductBottomViewDelegate:class  {
...
class LeeProductBottomView: UIView {
    weak var delegate:LeeProductBottomViewDelegate?
...
extension LeeProductBottomView {
...
extension LeeProductBottomView :UICollectionViewDataSource {
...
extension LeeProductBottomView :UICollectionViewDelegate {
...
extension LeeProductBottomView {
    func changePageControler(_ index:Int)  {
        ...
        myCollectionView.setContentOffset(CGPoint(x: offX,y:0), animated: true)
